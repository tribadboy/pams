...
public final class PathConstant {
	...
	final public static String WEB_AUTHC_USER_PERMISSION = "/web/authc/user/permission/";
	...
	final public static String WEB_AUTHC_FINANCE_STRATEGY = "/web/authc/finance/strategy/";
