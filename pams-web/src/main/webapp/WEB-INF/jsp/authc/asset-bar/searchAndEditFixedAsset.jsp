    ...
    BUI.use(['bui/form','bui/grid','bui/data'],function(Form,Grid,Data){
        ...
        var form = new Form.HForm({
         ...
         var Grid = BUI.Grid,
          ...
          columns = [
            { title: '资产名称',width: 100,  sortable: false, dataIndex: 'recordName'},
            { title: '价值', width: 100, sortable: true, dataIndex: 'recordValue'},
        ...
        function delItems(items){
          ...
          if(ids.length > 0){
            BUI.Message.Confirm('确认要删除记录么？',function(){
              $.ajax({
                url : '/pams-web/web/authc/asset/fixedAsset/deleteFixedAssetInfo',
                type: "post",
                dataType : 'json',
                data : "assetIds="+ids,
