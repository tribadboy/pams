  ...
  <div class="container">
    <div class="row">
      <form id="J_Form" class="form-horizontal span24" 
      		action="<%=path %>/web/authc/system/notice/add"  method="POST" >
        ...
        <div class="row">
          <div class="control-group span15">
            <label class="control-label"><span class="redText">*</span> 公告内容：</label>
            <div class="controls control-row8">
              <textarea name="message" class="input-large" data-tip="{text:'请填写公告内容！'}" 
