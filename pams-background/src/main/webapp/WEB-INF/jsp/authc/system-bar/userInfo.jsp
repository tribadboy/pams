 ...
 <body>
  ...
  <div class="container">
    <div class="detail-page">   
 		...
 		<input type=text style="display:none" name="informId" id="loanId" value="${informId }">
          <div class="row">
            <div class="control-group span20">
             	<div class="control-group span8">
          		...
          		<div class="control-group span30">
            		<input type="radio" value="0" name="type" checked> <label>已选定的用户</label>
            		<input type="radio" value="1" name="type"> <label>所有用户</label>
            	</div>     
