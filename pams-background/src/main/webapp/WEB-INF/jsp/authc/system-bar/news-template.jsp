  		...
  		<div align="center">			
  			<div class="detail-page" align="center">
 				<div class="row">
					...
					<img src="<%=path %>/web/authc/system/news/getNewsPicture?pictureName=${news.pictureName}" width="300px" height="200px" id="img-change">
 				</div>
 				<div class="row">
 					<label style="font-size:15px">点击选择新闻图片</label>
 				</div>
 				<br>
 				<div class="row">
	...
	$(function () {
	    $("#btn").click(function () {
	    	...
	    	if ($("#file").val().length > 0) {
    			$.ajaxFileUpload({
        			url: '<%=path%>/web/authc/system/news/newsPictureUpload',
        			type: 'POST',
        			data : { newsId : newsId },
        			secureuri: false,
        			fileElementId:'file',
